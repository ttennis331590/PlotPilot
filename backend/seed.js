...
const sampleStories = [
  "Once upon a time, in a world where people could see the color of others' emotions, there was a young painter named Alex. Alex had a peculiar problem: they could only see in black and white. This made their life dull and dreary, as they could not experience the vibrant colors that others could. One day, Alex met someone named Taylor, whose emotions appeared in vivid colors. Inspired by this newfound ability, Alex began to create stunning masterpieces that reflected the true emotions of those around them. As their artwork gained recognition, Alex realized the beauty of their unique perspective and embraced their monochromatic world. They continued to paint, capturing the essence of human emotion in a way that had never been seen before.",
  "In a society where everyone is born with a unique tattoo that represents their destiny, a young woman named Luna had an unidentifiable mark. Luna's mark was unlike any other, and she was often ridiculed for its mysterious nature. Tired of the torment, she set off on a journey to decipher its meaning. Along the way, she encountered various characters, each with their own unique marks and destinies. As Luna unraveled the truth behind her mark, she uncovered a hidden truth that threatened to change her world forever. Her mark was an ancient symbol, foretelling the rise of a powerful leader who would unite the world. As she embraced her destiny, Luna became the beacon of hope her world desperately needed.",
  "A lonely lighthouse keeper discovers a magical seashell that allows him to communicate with a mermaid living in the depths of the ocean. As their friendship grows, they must find a way to bridge the gap between their two worlds before it's too late.",
  "A skilled clockmaker in a steampunk city accidentally creates a pocket watch that controls time itself. When the watch falls into the wrong hands, the clockmaker must race against the clock to recover it before the fabric of time unravels.",
];
